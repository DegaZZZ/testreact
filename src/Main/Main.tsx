...
if (window.location.href === "http://localhost:3000/russian"){
    link = "https://vk.com/video_ext.php?oid=-211941733&id=456239177&hash=320cbbbc09eb7482";
}

else if(window.location.href === "http://localhost:3000/intershum"){
    link = "https://vk.com/video_ext.php?oid=-211941733&id=456239178&hash=fdd4cc8757face86";
}

else if(window.location.href === "http://localhost:3000/english"){
    link = "https://vk.com/video_ext.php?oid=-211941733&id=456239179&hash=a3e3f73e33a58ff3";
}
